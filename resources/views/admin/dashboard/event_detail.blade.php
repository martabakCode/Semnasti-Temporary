        ...
        <div class="col-xl-12">
          <div class="card event-detail-bx overflow-hidden">
            <div class="card-media">
              <img src="{{ asset('images/hill.jpg') }}" alt="" class="w-100">
            </div>
            <div class="card-body">
              <div class="d-flex flex-wrap align-items-center mb-4">
                <h2 class="text-black col-xl-6 p-0 col-xxl-12 mr-auto title mb-3">Envato Atuhor Community Fun Hiking at Sibayak Mt.</h2>
                <div class="d-flex align-items-center">
                  <a href="javascript:void(0)" class="btn btn-primary light mr-3"><i class="fa fa-users mr-3 scale5" aria-hidden="true"></i>Socials Activity</a>
                ...
                <div class="col-lg-3 col-md-6 col-xxl-6 mb-3">
                  <div class="media bg-light p-3 rounded align-items-center">	
                    ...
                    <div class="media-body">
                      ...
                      <span class="fs-16 text-black">$124,00</span>
                    </div>
                  </div>
                </div>
                <div class="col-lg-4 col-md-6 col-xxl-6 mb-3">
                  <div class="media bg-light p-3 rounded align-items-center">	
                    ...
                    <div class="media-body">
                      ...
                      <span class="fs-16 text-black">Sunday, 12 June 2020</span>
                    </div>
                  </div>
                </div>

(function ($) {
    ...
    var dzChartlist = (function () {
        ...
        const paidPaymentElement = document.getElementById("paid-payment");
        ...
        const paidPayment = Number(paidPaymentElement.textContent);
        const pendingPayment = Number(pendingPaymentElement.textContent);

        // Log the result to the console
        var donutChart = function () {
            var options = {
                series: [paidPayment, pendingPayment],
                chart: {
                    type: "donut",
                },
                legend: {
